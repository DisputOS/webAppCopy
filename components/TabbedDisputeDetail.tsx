            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
              ...
              <div className="flex space-x-6 mt-4 justify-center">
                <button
                  ...
                  className="p-2 rounded-lg bg-gray-200 bg-opacity-20 hover:bg-opacity-30"
                >
                ...
                <Link
                  href={pdfReady ? (dispute.pdf_url as string) : "#"}
                  className="p-2 rounded-lg bg-gray-200 bg-opacity-20 hover:bg-opacity-30"
                >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  {proofs.map((p) => (
                    ...
                    >
                      ...
                      />
                      <p className="p-2 text-xs text-gray-400 truncate">

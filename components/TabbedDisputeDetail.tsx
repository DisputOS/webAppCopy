      ...
      {activeTab === 'details' && (
        <section className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="#upload" onClick={() => setActiveTab('upload')} className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
              <FileUp className="w-4 h-4" /> Add Proof
            </Link>
            <Link href="#generate" className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">

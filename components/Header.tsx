...
export default function Header() {
 ...
 return () => {                               // ✅ returns void
  ...
  // ---------------------------------------------------------------------------
  return (
    <header className="w-full sticky top-0 z-20 flex items-center justify-between to-black/90 backdrop-blur px-6 py-4 border-b border-gray-800 p-4 z-50 relative">

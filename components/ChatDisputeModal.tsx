...
export default function ChatDisputeModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="animate-fade-up animate-once animate-ease-in backdrop-blur-xl fixed inset-0 z-50 flex items-center justify-center overflow-hidden">
      ...
      {showDisclaimer ? (
        <div className="animate-fade-up2 animate-once2 animate-ease-in2 .animate-delay-1000 bg-white/10 text-white backdrop-blur-xl border border-white/20 shadow-2xl rounded-3xl max-w-md w-full p-6 text-center z-10">
